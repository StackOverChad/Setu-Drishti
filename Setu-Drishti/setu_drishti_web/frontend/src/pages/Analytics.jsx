...
export default function Analytics() {
  ...
  return (
    <div className="p-8 h-full flex flex-col max-w-7xl mx-auto">
      <h2 className="text-2xl font-bold text-gray-100 uppercase tracking-widest mb-6">Hospital-Wide AI Impact</h2>
      
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-[#0f1522] p-6 rounded-lg border border-purple-900/50 shadow-[0_0_15px_rgba(168,85,247,0.1)] relative overflow-hidden">
        ...
        <div className="bg-[#0f1522] p-6 rounded-lg border border-cyan-900/50 shadow-[0_0_15px_rgba(34,211,238,0.1)] relative overflow-hidden">
        ...
        <div className="bg-[#0f1522] p-6 rounded-lg border border-green-900/50 shadow-[0_0_15px_rgba(34,197,94,0.1)] relative overflow-hidden">
      ...
      <div className="bg-[#0f1522] p-8 rounded-lg border border-gray-800 flex-grow min-h-[400px]">
         <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-6 border-b border-gray-800 pb-4">Early Sepsis Catch Rate (Trailing 5 Days)</h3>
